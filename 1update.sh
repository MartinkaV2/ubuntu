...
# Dont turn off the screen after 5 mins
...
# Delete Desktop and Public folders
#sudo rm -rf Desktop Public
...
sudo apt update && sudo nala install linux-xanmod-x64v3 -y

# Autoremove at the beginning causes issues sometimes so it is disabled for now
